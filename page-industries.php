...
<!-- Industries Hero -->
<section id="industriesHero" class="py-14 lg:py-28">
...
<section id="industriesHero" class="py-2 lg:py-14">
    <div class="container mx-auto px-4 lg:px-0">
        <div class="lg:w-[80%] mx-auto">
            <?php if( have_rows('services_hero_content') ): ?>
                <?php while( have_rows('services_hero_content') ): the_row(); 
                    ...
                    <h2 class="servicesContent_heading text-center lg:text-start font-inter font-semibold text-black mb-5"><?php echo $industriesHeading; ?></h2>
                    <div class="font-inter font-light text-center lg:text-start text-black text-md lg:text-lg leading-6 lg:leading-5"><?php echo $industriesDescription; ?></div>
                <?php endwhile; ?>
            <?php endif; ?>
        </div>
    </div>
...
<section id="trustedIndustries" class="pb-14 pt-14 lg:pt-36">
    <div class="container mx-auto px-4 lg:px-0">
