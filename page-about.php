...
<section id="aboutUs_hero" >
    ...
    <!-- Content -->
    <div class="aboutUs_hero__content h-[25vh] w-full">
        <div class="container mx-auto flex justify-center">
            <?php if( have_rows('about_page_content') ): ?>
                ...
                <div class="aboutUs_content__wrapper bg-darkBlue w-[1000px] min-h-[350px] flex justify-center items-center px-16 py-10 rounded-3xl -mt-[15%]">
                    <div class="">
            ...
            <?php
                ...
                <div class="grid grid-cols-4 gap-6">
                    ...
                    if ($projectQuery->have_posts()) :
                        ...
                        <div class="aboutUs_serviceCard rounded-2xl h-[200px] w-[290px] relative" style="background-image: url('<?php echo $servicesThumbnail; ?>')">
...
<section id="aboutUs_faq" class="pt-14 pb-32">
    <div class="container mx-auto">
