...
<!-- Hero Section -->
<section id="homepage_hero" class="w-full h-[100vh] lg:h-[55vh] xl:h-[84vh] relative">
    ...
    <div class="blackOverlay"></div>
        <div class="container mx-auto my-auto flex justify-start items-center h-full w-full">
            <div class="hero_content__wrapper lg:max-w-[500px] px-2 xl:px-0">
                <?php if( have_rows('homepage_hero_content') ): ?>
                    <?php while( have_rows('homepage_hero_content') ): the_row(); 
                        ...
                        ?>
                        <!-- Hero Content -->
                        <h1 class="heroHeading text-center lg:text-left text-white font-bold font-halveticaBold mb-2 relative"><?php echo $heroHeading; ?></h1>
                        <p class="heroSubheading text-center lg:text-left text-white font-light font-halveticaLight mb-6 relative"><?php echo $heroSubheading; ?></p>
...
<section id="homepage_ourServices" class="bg-white py-14 xl:py-36">
    <div class="container mx-auto">
        <div class="xl:grid xl:grid-cols-7 gap-14">
            <!-- Left side -->
            <div class="col-span-2 xl:max-w-[315px] my-auto px-4 xl:px-0">
                <?php if( have_rows('homepage_our_services') ): ?>
                    ...
                    <h2 class="sectionHeading text-center xl:text-left font-inter text-black font-normal mb-2"><?php echo $ourServicesHeading ?></h2>
                    <p class="sectionSubheading text-center xl:text-left font-inter text-black text-lg font-light mb-6"><?php echo $ourServicesSubheading ?></p>
                ...
                <?php
                    ...
                    <div class="block lg:grid lg:grid-cols-2 gap-6 mx-auto">
                        ...
                        if ($projectQuery->have_posts()) :
                            ...
                            <div class="servicesCard h-[20vh] xl:h-[25vh] w-auto xl:w-[420px] relative my-4 lg:my-0 mx-3 lg:mx-0" style="background-image: url('<?php echo $servicesThumbnail; ?>')">
...
<section id="industrySpecializations" class="bg-white lg:pt-10 md:pb-14 lg:pb-24">
    <div class="container mx-auto relative rounded-2xl">
        <div class="industrySpecializationsCard h-[850px] md:h-[730px] lg:h-[600px] w-full">
            <div class="grid lg:grid-cols-2 gap-5 absolute w-full h-full p-5 md:p-14">
                    ...
                    <?php while( have_rows('homepage_industry_specializations') ): the_row(); ?>
                        <?php if( have_rows('homepage_industries_specializations_industries') ): ?>
                            ...
                            <div class="order-last lg:order-first flex justify-center items-center">
                                <ul class="bg-red px-10 py-5 xl:py-14 w-auto xl:w-[412px] rounded-2xl md:mt-5 lg:mt-0">
                                    <?php
                                    // Repeater Loop
                                    if( have_rows('industries_specialization_repeater') ):
                                        while( have_rows('industries_specialization_repeater') ) : the_row();
                                            ...
                                            <li class="industries_listItem text-center lg:text-start text-white font-inter font-light text-xl lg:text-2xl py-3"><?php echo $industries; ?></li>
                        ...
                        <?php if( have_rows('homepage_industries_specializations_content') ): ?>
                            ...
                            ?>
                            <!-- Industries Content -->
                            <div class="flex justify-start items-center xl:ml-10">
...
<!-- About Us Section -->
<section id="aboutUs" class="bg-red py-14 lg:py-24 xl:py-64">
    <div class="container mx-auto">
            ...
            <div class="grid lg:grid-cols-2 gap-4">
                <?php if( have_rows('homepage_about_us_content') ): ?>
                    ...
                    <div class="flex justify-start items-center">
                        <div class="lg:w-[570px] px-4 xl:px-0">
                ...
                ?>
                <div class="aboutUs_thumbnail__wrapper flex justify-center lg:justify-end items-center px-4 xl:px-0 mt-3 lg:mt-0">
                <?php 
                    if( $aboutUsThumbnail ) {
...
<!-- Contact Section -->
<section id="homepage_contact" class="bg-white md:pb-14 lg:pb-24">
    <div class="h-[90vh] md:h-[70vh] lg:h-[50vh] xl:h-[80vh] 2xl:h-[100vh] w-full relative">
        <div class="homepage_contact__upperWrapper w-full h-full">
            <div class="container mx-auto relative">
                <div class="homepageContactContent_wrapper absolute text-center mt-20 px-4 xl:px-0 min-w-[auto] md:min-w-[700px] lg:min-w-[auto]">
                    <?php if( have_rows('homepage_contact_section') ): ?>
                        ...
                        <div class="max-w-[1240px]">
                            ...
                            <div class="flex justify-center">
                                <p class="aboutUs_paragraph font-halveticaLight text-white lg:max-w-[860px] mb-8"><?php echo $contactUsParagraph; ?></p>
                            </div>
    ...
    <!-- Contact Form -->
    <div class="fontPage_contactForm__wrapper flex justify-center relative px-5 xl:px-0 -mt-[-70%] md:-mt-[35%] lg:-mt-[30%] xl:-mt-[15%]">
        <div class="contactPage_contactForm text-white px-4 lg:px-16 py-5 lg:py-10">
            <h3 class="contactForm_heading text-center text-white font-halveticaBold mb-3 md:mb-9">Request For Quote</h3>
            <?php echo do_shortcode($contactUsShortcode); ?>
        </div>
    </div>

    <div class="frontPage_bottomSpace bg-white h-[5vh] lg:h-[70vh] xl:h-[105vh] w-full">
    </div>
        <?php endwhile; ?>
    <?php endif; ?>
</section>
