...
<!-- Services Hero -->
<section id="servicesHero" class="py-14 lg:py-28">
...
<section id="servicesContent" class="py-2 lg:py-14">
    <div class="container mx-auto px-4 lg:px-0">
        ...
        <?php if( have_rows('services_content') ): ?>
            <?php while( have_rows('services_content') ): the_row(); 
                ...
                <h2 class="text-center lg:text-start servicesContent_heading font-inter font-semibold text-black mb-5"><?php echo $servicesHeading; ?></h2>
                <div class="text-center lg:text-start font-inter font-light text-black text-lg leading-6 lg:leading-5"><?php echo $servicesDescription; ?></div>
            <?php endwhile; ?>
        <?php endif; ?>
        </div>
    </div>
...
<!-- What we do Section -->
<section id="servicesWhatWeDo" class="pb-14 lg:pb-24 pt-14 lg:pt-36">
    <div class="container mx-auto">
        <h2 class="servicesWhatWeDo_heading text-center font-inter text-black font-semibold">What we do</h2>
        <p class="font-inter font-light text-black text-md lg:text-lg leading-5 text-center">But not limited to.</p>
        ...
        <div class="grid lg:grid-cols-2 gap-6 my-5 lg:my-14 px-4 lg:px-0">
            <?php 
            // The Loop
